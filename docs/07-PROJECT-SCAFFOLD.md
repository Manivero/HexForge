...
Все изменения перепроверены: `cargo test --workspace` — 128/128 зелёных (Rust) + 40 FE-юнитов
(core 9, ops 59, stream 7, engine 31, tauri 22, cli 4 — включая IPC-parity golden-тесты,
