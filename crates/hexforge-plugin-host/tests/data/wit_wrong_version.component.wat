;; Fixture for the WIT contract-version gate: identical to
;; wit_uppercase.component.wat except the instance export is pinned to a
;; contract version this host does not speak. Install must refuse it with
;; `Incompatible`, discovery must mark it `Incompatible` — never Verified.
;;
...
(component
  ...
  (export "hexforge:plugin/transform@9.9.9" (instance $trans))
)
